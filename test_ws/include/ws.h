...
extern ECS_COMPONENT_DECLARE(ecs_ws_t);

extern void ws_flecs_init(ecs_world_t *world);
extern int ws_socket(struct ws_events *evs, uint16_t port, int thread_loop, ecs_world_t *world);
